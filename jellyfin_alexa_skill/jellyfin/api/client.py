...
class JellyfinClient:
    ...
    def get_shuffle(self,
                      ...
                      **kwargs) -> dict:
        """
        Get a shuffled playlist for a specified user.
        :param user_id: user id of the user whose shuffled items should be retrieved
        :param token: authentication token
        :param limit: maximum number of results to return (default: 250)
        :param media_type: media type of the shuffled items to retrieve
        :param kwargs: additional parameters to pass to the server for the request
        :return: dict of shuffled items
        :raises: requests.exceptions.HTTPError types if the server is not reachable or something went wrong
        """
        params = {
            "Recursive": True,
